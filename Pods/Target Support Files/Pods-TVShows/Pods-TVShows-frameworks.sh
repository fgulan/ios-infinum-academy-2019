...
if [[ "$CONFIGURATION" == "AppStore_Debug" ]]; then
...
if [[ "$CONFIGURATION" == "Development_Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AHKNavigationController/AHKNavigationController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Alamofire/Alamofire.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AlamofireNetworkActivityIndicator/AlamofireNetworkActivityIndicator.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AlamofireNetworkActivityLogger/AlamofireNetworkActivityLogger.framework"
...
if [[ "$CONFIGURATION" == "AppStore_Release" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AHKNavigationController/AHKNavigationController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Alamofire/Alamofire.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AlamofireNetworkActivityIndicator/AlamofireNetworkActivityIndicator.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AlamofireNetworkActivityLogger/AlamofireNetworkActivityLogger.framework"
...
if [[ "$CONFIGURATION" == "Development_Release" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AHKNavigationController/AHKNavigationController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Alamofire/Alamofire.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AlamofireNetworkActivityIndicator/AlamofireNetworkActivityIndicator.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AlamofireNetworkActivityLogger/AlamofireNetworkActivityLogger.framework"
